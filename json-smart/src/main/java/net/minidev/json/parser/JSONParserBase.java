...
abstract class JSONParserBase {
	 ...
	 */
	protected <T> T parse(AMapper<T> mapper) throws ParseException {
		this.pos = -1;
		T result;
		try {
			read();
	...
	protected <T> T readArray(AMapper<T> mapper) throws ParseException, IOException {
	 ...
	 * generated by a ContainerFactory
	 */
	protected <T> T readFirst(AMapper<T> mapper) throws ParseException, IOException {
		for (;;) {
			switch (c) {
			// skip spaces
			case ' ':
	 ...
	 * generated by a ContainerFactory
	 */
	protected Object readMain(AMapper<?> mapper, boolean stop[]) throws ParseException, IOException {
		for (;;) {
			switch (c) {
			// skip spaces
			case ' ':
