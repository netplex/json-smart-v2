 ...
 * classes. It supports conversion from {@link Number} instances and {@link String} representations
 * of numbers to their corresponding primitive types or wrapper classes. Conversion from types that
 * are not supported will result in a {@link ConvertException}.
 */
public class DefaultConverter {
  ...
  public static Integer convertToInt(Object obj) {
    ...
    if (c == Integer.class) return (Integer) obj;
  ...
  public static Short convertToShort(Object obj) {
    if (obj == null) return null;
    Class<?> c = obj.getClass();
    if (c == Short.class) return (Short) obj;
  ...
  public static Byte convertToByte(Object obj) {
    if (obj == null) return null;
    Class<?> c = obj.getClass();
    if (c == Byte.class) return (Byte) obj;
    if (obj instanceof Number) return Byte.valueOf(((Number) obj).byteValue());
    throw new ConvertException(
        "Primitive: Can not convert " + obj.getClass().getName() + " to Byte");
  }
  ...
  public static Float convertToFloat(Object obj) {
    if (obj == null) return null;
    Class<?> c = obj.getClass();
    if (c == Float.class) return (Float) obj;
  ...
  public static Double convertToDouble(Object obj) {
    if (obj == null) return null;
    Class<?> c = obj.getClass();
    if (c == Double.class) return (Double) obj;
   ...
   *
   * @param obj the object to convert
   * @return the converted char value, or a space character if the object is {@code null} or the
   *     string is empty
  ...
  public static char convertTochar(Object obj) {
    ...
    if (obj instanceof String)
      if (((String) obj).length() > 0) return ((String) obj).charAt(0);
      else return ' ';
    throw new ConvertException(
  ...
  public static Character convertToChar(Object obj) {
    if (obj == null) return null;
    Class<?> c = obj.getClass();
    if (c == Character.class) return (Character) obj;
    if (obj instanceof String)
      if (((String) obj).length() > 0) return ((String) obj).charAt(0);
      else return ' ';
    throw new ConvertException(
   ...
   *
   * @param obj the object to convert
   * @return the converted boolean value, false if the object is {@code null} or represents the
   *     numeric value 0
   * @throws ConvertException if the object cannot be converted to a boolean
   */
  public static boolean convertTobool(Object obj) {
    if (obj == null) return false;
    if (obj.getClass() == Boolean.class) return ((Boolean) obj).booleanValue();
    if (obj instanceof String) return Boolean.parseBoolean((String) obj);
    if (obj instanceof Number) {
      if (obj.toString().equals("0")) return false;
      else return true;
    }
    throw new ConvertException(
  ...
  public static Boolean convertToBool(Object obj) {
    if (obj == null) return null;
    Class<?> c = obj.getClass();
    if (c == Boolean.class) return (Boolean) obj;
    if (obj instanceof String) return Boolean.parseBoolean((String) obj);
    throw new ConvertException(
        "Primitive: Can not convert " + obj.getClass().getName() + " to Boolean");
  }
