 ...
 *
 * <p>{@link JSONTraverser} accepts an action and provides callback hooks for it to act on the
 * traversed nodes at each significant step. See {@link JSONTraverseAction}.
 *
