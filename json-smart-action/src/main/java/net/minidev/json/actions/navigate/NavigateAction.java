...
public interface NavigateAction<M extends Map<String, Object>, L extends List<Object>> {
  ...
  /**
   * called when a leaf node is reached in a M. a leaf in a M is a key-value pair where the value is
   * not a container itself (it is not a M nor a L)
   *
  ...
  /**
   * called when a leaf in a L is reached. a leaf in a L is a non-container item (it is not a M nor
   * a L)
   *
   * @param tp -
   * @param arrIndex -
